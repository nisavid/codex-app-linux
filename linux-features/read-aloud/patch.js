...
function readAloudRuntimeSource() {
  return [
    ...
    `installStyle();globalThis[${JSON.stringify(HELPER_MARKER)}]=click;globalThis[${JSON.stringify(SETUP_MARKER)}]=setup;})();`,
  ].join("");
}
