...
colors:
  ...
  updater-sha-chip-outline: "#9AA0A6"
typography:
  body-md:
...
- **Updater SHA Muted Gray** (`#9AA0A6`, `rgba(120,120,120,0.16)`,
  ...
  compact metadata. Frontmatter token key: `updater-sha-chip-outline`. The rgba
  values are prose-only evidence because DESIGN.md frontmatter colors must stay
  hex sRGB.
