...
patchFileFirstMatch(path.join(scriptsDir, "browser-client.mjs"), {
  ...
  oldTexts: [
    {
      oldText: String.raw`codexLinuxChromeUserDataDirectories=()=>E7()==="linux"?[S7(v7(),".config","BraveSoftware","Brave-Browser"),S7(v7(),".config","google-chrome"),S7(v7(),".config","google-chrome-beta"),S7(v7(),".config","google-chrome-unstable"),S7(v7(),".config","chromium")]:[Cd]`,
      newText: String.raw`codexLinuxChromeUserDataDirectories=()=>E7()==="linux"?[S7(v7(),".config","BraveSoftware","Brave-Browser"),S7(v7(),".config","google-chrome"),S7(v7(),".config","google-chrome-beta"),S7(v7(),".config","google-chrome-unstable"),S7(v7(),".config","chromium"),S7(v7(),".config","thorium")]:[Cd]`,
    },
    {
    ...
    },
    {
      ...
      newText: String.raw`codexLinuxChromeUserDataDirectories=()=>S$()==="linux"?[w$(x$(),".config","BraveSoftware","Brave-Browser"),w$(x$(),".config","google-chrome"),w$(x$(),".config","chromium"),w$(x$(),".config","thorium")]:[md]`,
    },
    {
...
patchFileFirstMatch(path.join(scriptsDir, "browser-client.mjs"), {
  ...
  alreadyText: ["async(e,t,r=hl)", "async(e,t,r=md)"],
});
...
patchFileFirstMatch(path.join(scriptsDir, "browser-client.mjs"), {
  ...
  alreadyText: ["r.length===1?r[0]:null},u9=async", "r.length===1?r[0]:null},D$=async"],
});
